...
public class ContestDescriptionBean implements Serializable {
    ...
    private static final String NO_SPECIAL_CHAR_REGEX = "^[a-zA-Z:.,;'’0-9äöüÄÖÜáÁéÉíÍóÓúÚñ?! ]*$";
    ...
    @Length(min = 3, max = 1024, message = "The contest question must be at least 3 characters and"
            + " not more than 1024 characters.")
    private String question;

    @Length(min = 3, max = 150, message = "The contest title must be at least 3 characters and not"
            + " more than 150 characters.")
    @Pattern(regexp = NO_SPECIAL_CHAR_REGEX, message = "The contest title must not contain "
            + "special characters.")
    private String title;

    @Length(max = 10000, message = "The contest description must have not more than 10000 "
