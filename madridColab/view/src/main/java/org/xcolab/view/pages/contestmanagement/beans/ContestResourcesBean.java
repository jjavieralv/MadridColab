...
public class ContestResourcesBean implements Serializable {
    ...
    private static final String[] BASE_SECTION_TITLES = {
            "Contexto", "Aspectos clave", "Criterios de evaluación",
            "Premios", "Recursos adicionales"
    };
    private static final List<String> IGNORE_SECTION_TITLES = Arrays.asList("Resumen", "\u00a0");
    ...
    private static final String OVERVIEW_VIEW_PROPOSALS_TITLE = "Ver Propuestas:";
    ...
    private static final String OVERVIEW_SUBMIT_PROPOSALS_TITLE = "Enviar Propuestas:";
    ...
    private static final String OVERVIEW_RULES_TITLE = "Reglas:";
    private static final String OVERVIEW_DEADLINE_TITLE = "Fecha límite:";
    ...
    private static final String OVERVIEW_RULES_CONTENT =
            "Todos los participantes acceptan las <rules-link/> y los "
                    +
                    "<a href=\"/page/Terms-of-use\" target=\"_blank\">Terminos de uso</a>";
    ...
    public void fillOverviewSectionContent(Contest contest) {
        ...
        for (ContestPhase contestPhase : contestPhaseList) {
            ...
            if (contestPhaseType == 1L) {
                ...
                if (phaseHasNoEnd) {
                    proposalSubmissionEndDate = "Este reto no tiene fecha límite.";
                } else {
        ...
        overviewSectionValues.put("Pregunta:", contest.getQuestion());
        ...
        final String rulesLink = "<a href=\"" + contestType.getRulesPageUrl()
                + "\" target=\"_blank\">Reglas del reto</a>";
